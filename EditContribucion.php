...
<head>
    ...
    <title>Editar Contribución</title>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row no-gutters">
                    <div class="content col-xl-5 d-flex align-items-stretch">
                        <div class="content">
                            <h3>Edición de Contribuciones</h3>
                            <p>
                                Esta es la seccion de la sección de contribuciones que se mostraran en la pagina<br>
                            </p>
        ...
        <section id="tabs" class="tabs" style="padding-top: 20px;">
            <div class="container" data-aos="fade-down">
                <div style="padding-top: 20px; padding-bottom: 0px;">
                    ...
                    require_once("assets/vendor/php/editContribucionControl.php");
                    ...
                    <form class="shadow p-3 mb-5 bg-white rounded" action="" method="POST" style="padding: 30px 30px;" enctype="multipart/form-data">
                        <h5 style="margin-top:-16px; margin-left: -16px; margin-right: -16px;
                            ...
                            Detalles de la sección de Contribución
                        </h5>
                        <br>
                        <div class="row" style="padding-left: 30px">
                            <div class="col-xl-1 mb-1">
                                <label style="padding-bottom: 10px;">ID:</label>
                                <input type="text" class="form-control text-center" value="<?php echo $contribucion->id ?>" placeholder="ID..." disabled>
                            </div>
                            <div class="col-xl-5 mb-5">
                                <label style="padding-bottom: 10px;">Contribución:</label>
                                <input type="hidden" value="<?php echo $contribucion->id ?>" name="id">
                                <input type="text" name="txt_contribucion" maxlength="255" class="form-control text-center" value="<?php echo $contribucion->contribucion ?>" placeholder="Texto" required>
                            </div>
                            <div class="col-xl-3 mb-3">
                                <button type="submit" name="btn_actualizar_contribucion" class="btn login-btn" value="saveurl" style="margin-top: 32px;">
                                    Actualizar datos y publicar
                                </button><br>
                            </div>
                        </div>
                        <div class="row" style="padding-left: 30px">
                            <span style="font-style: italic;">Esto aparecerá en la sección de <b>¿Cómo contribuir?</b></span>
                        </div>
                    </form>
