                        ...
                        <form class="shadow p-3 mb-5 bg-white rounded" action="" method="POST" style="padding: 30px 30px;" enctype="multipart/form-data">
                           ...
                           <div class="row" style="padding-left: 30px">
                              <div class="col-xl-3 mb-3">
                                 ...
                                 <input type="text" maxlength="24" name="txt_name" class="form-control text-center" 
                              ...
                              <div class="col-xl-2 mb-3">
                                 ...
                                 <input type="number" min="0" max="11" name="txt_edad_meses" 
                                    class="form-control text-center" placeholder="0">
                              </div>
                              <div class="col-xl-3 mb-3">
                                  ...
                                  <tr>
                                    ...
                                    <td style="vertical-align: middle;">
                                       <div class="btn-group" role="group" aria-label="">
                                          ...
                                          <a href="assets/vendor/php/panel_de_control_delete.php?action=borrar&id=<?php echo $item->id; ?>" 
                                             type="submit" class="btn btn-outline-danger" name="btnBorrar">Borrar</a>
                                       </div>
                                    </td>
                                 </tr>
                                 <?php } ?>
                                 ...
                                 <tr>
                                    ...
                                    <td style="vertical-align: middle;">
                                       <div class="btn-group" role="group" aria-label="">
                                          ...
                                          <a href="assets/vendor/php/panel_de_control_usuario.php?action=borrarU&id=<?php echo $usuario->id; ?>"  
                                             type="submit" class="btn btn-outline-danger" name="btnBorrar">Borrar</a>
                                       </div>
                                    </td>
                                 </tr>
                     ...
                     <!-- GESTIÓN DE CUENTA AQUÍ -->
                        ...
                        <form class="shadow p-3 mb-5 bg-white rounded" action="" method="POST" style="padding: 30px 30px;">
                           ...
                           <div class="row" style="padding-left: 30px">
                              <div class="col-xl-3 mb-3">
                                 <label style="padding-bottom: 10px;">Password:</label>
                                 <input type="password" name="txt_current_password_ed" class="form-control text-center" 
                                    placeholder="Contraseña actual..." 
                                    maxlength="16">
                              </div>
                              <div class="col-xl-3 mb-3">
                                 <label style="padding-bottom: 10px;">Nueva password:</label>
                                 <input type="password" name="txt_new_password_ed" class="form-control text-center" 
                                    placeholder="Nueva contraseña..." maxlength="16">
                              </div>
                              <div class="col-xl-3 mb-3">
                                 <label style="padding-bottom: 10px;">Reingrese nueva password:</label>
                                 <input type="password" name="txt_password_check_ed" class="form-control text-center" 
                                    placeholder="Nueva contraseña..." maxlength="16">
