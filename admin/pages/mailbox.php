...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../dist/img/dog.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          ...
          <div class="card">
            ...
            <div class="card-body p-0">
              <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">
                    <i class="far fa-envelope"></i> Respondidos
                  </a>
                </li>
              </ul>
            </div>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="read-mail.html">Roberto</a></td>
                    <td class="mailbox-subject"><b>Asunto 2</b> - Buscando...
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-star"><a href="#"><i class="fas fa-star-o text-warning"></i></a></td>
                    <td class="mailbox-name"><a href="read-mail.html">Roberto</a></td>
                    <td class="mailbox-subject"><b>Asunto 3</b> - Buscando...
                    </td>
                    <td class="mailbox-attachment"><i class="fas fa-paperclip"></i></td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-star"><a href="#"><i class="fas fa-star text-warning"></i></a></td>
                    <td class="mailbox-name"><a href="read-mail.html">Roberto</a></td>
                    <td class="mailbox-subject"><b>Asunto 4</b> - Buscando...
                    </td>
                    <td class="mailbox-attachment"></td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-star"><a href="#"><i class="fas fa-star text-warning"></i></a></td>
                    <td class="mailbox-name"><a href="read-mail.html">Roberto</a></td>
                    <td class="mailbox-subject"><b>Asunto 5</b> - Buscando...
                    </td>
                    <td class="mailbox-attachment"><i class="fas fa-paperclip"></i></td>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024 <a href="https://adopterosargentina.com">Adopteros Argentina</a>.</strong>
    All rights reserved.
