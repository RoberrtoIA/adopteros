      ...
      <div class="container d-flex align-items-center">
         ...
         <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
               ...
               <li class="dropdown">
                  <a class="nav-link scrollto" href="inicio.php #adopcion"> <span>Adopción y cuidado</span><i class="bi bi-chevron-down"></i></a>
                  <ul>
                     <li><a class="nav-link scrollto" href="inicio.php #contribuir">¿Cómo contribuir?</a></li>
                     <li><a class="nav-link scrollto" href="inicio.php #requisitos2">Requisitos para adoptar</a></li>
                  </ul>
               </li>
