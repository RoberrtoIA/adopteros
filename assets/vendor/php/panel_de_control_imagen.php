<?php
    ...
    $img_editada_con_exito = false;
	if (isset($_POST['btn_actualizar_imagen_landing'])) {
		
		$directorio_destino = 'assets/img';
		$nombre_fichero = 'landing_img';
		...
		if ($saved) {
			...
			Imagen::UpdateLanding($uid_foto);
			$img_editada_con_exito = true;
		}
	}


    if (isset($_POST['btn_actualizar_imagen_contribucion'])) {
		
		$directorio_destino = 'assets/img';
		$nombre_fichero = 'contribuir_img';
		$tmp_name = $_FILES[$nombre_fichero]['tmp_name'];
		...
		if ($saved) {
			$uid_foto = $directorio_destino . '/' . $img_file;
			Imagen::UpdateContribuir($uid_foto);
			$img_editada_con_exito = true;
		}
	}
